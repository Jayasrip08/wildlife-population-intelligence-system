...
app = FastAPI(
    ...
    description="Backend API supporting Species Recognition, Bioacoustics, Population Estimation, Habitat Remote Sensing, and Conservation Health Scoring.",
    version="3.0.0"
)
...
@app.get("/")
def read_root():
    return {"message": "Welcome to Wildlife Population Intelligence System API (Milestone 3 Operational)"}
